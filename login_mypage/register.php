            ...
            <form action="register_confirm.php" method="post" enctype="multipart/form-data">
                <div class="form_contents">
                   ...
                   <div class="hissu">必須</div><label>メールアドレス</label><br>
                    <input type="text" class="formbox" size="40" name="mail" required pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
                    </div>
                    <div class="password">
                         <div class="hissu">必須</div><label>パスワード（半角英数６文字以上）</label><br>
                      ...
                      <div class="password">
                        ...
                        <input type="password" class="formbox" size="40" name="confirm password" id="confirm" oninput="ConfirmPassword(this)" pattern="^[a-zA-Z0-9]{6,}$" required>
                    </div>
                    <div class="picture">
